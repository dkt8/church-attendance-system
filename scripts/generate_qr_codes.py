...
def main():
    parser = argparse.ArgumentParser(description="Generate QR codes and ID cards for attendance system")
    parser.add_argument("csv_file", help="Path to CSV file containing student data")
    parser.add_argument("--output-dir", help="Output directory for generated files")
    parser.add_argument("--create-cards", action="store_true", help="Also create ID cards with QR codes")
